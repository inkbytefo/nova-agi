...
# A small subset of valid SMILES for fallback/testing
DEFAULT_SMILES = [
    ...
    "C1=CC=CC=C1", # Benzene (duplicate but fine)
    "CC1=CC=CC=C1", # Toluene
    "ClC1=CC=CC=C1", # Chlorobenzene
    "OC1=CC=CC=C1O", # Catechol
    "COC1=CC=CC=C1", # Anisole
    "CCN(CC)CC", # Triethylamine
    "C(C(C(C(C(C(=O)O)O)O)O)O)O", # Gluconic acid
    "C1=CN=CN1", # Imidazole
